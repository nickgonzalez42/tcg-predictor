...
export const {useLoginMutation, useUpdateUserAddressMutation, useFetchAddressQuery, useRegisterMutation, useLogoutMutation, useUserInfoQuery, useLazyUserInfoQuery} = accountApi;